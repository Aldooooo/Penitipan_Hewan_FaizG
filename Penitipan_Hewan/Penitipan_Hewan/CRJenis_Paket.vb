...
Public Class CRJenis_Paket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penitipan_Hewan.CRJenis_Paket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRJenis_Paket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRJenis_Paket = New CRJenis_Paket()
        rpt.Site = Me.Site
        Return rpt
    End Function
