...
Public Class CRPemantauan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penitipan_Hewan.CRPemantauan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPemantauan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPemantauan = New CRPemantauan()
        rpt.Site = Me.Site
        Return rpt
    End Function
